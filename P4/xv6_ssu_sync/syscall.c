...
static int (*syscalls[])(void) = {
    ...
    [SYS_close] sys_close,       [SYS_fork_rt] sys_fork_rt,
    [SYS_sem_init] sys_sem_init, [SYS_sem_wait] sys_sem_wait,
    [SYS_sem_post] sys_sem_post, [SYS_sem_destroy] sys_sem_destroy,
};
